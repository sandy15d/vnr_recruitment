...
(function() {
    ...
    var V = 20,
        ...
        da = function(h, n, v) {
            ...
            else "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? "," === n ? (K++, F = S, S = 0, 0 < E.length && (v = x + v)) : v = 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? n.slice(1, n.length - 1) + v : n + v : (n = 0 > U ? n.replace("+", "").replace("-", "") : n.replace("-", ""), v += n.replace(/[0]+/, function(a) {
                return W(U, a.length)
            }));
            x = "";
            for (M = !1; 0 < H.length;) n =
                H.shift(), "#" === n || "0" === n ? 0 < h.length && 0 !== Number(h.join("")) ? (x += h.shift(), M = !0) : "0" === n && (x += "0", M = !0) : 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? x += n.slice(1, n.length - 1) : "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? x += n : (n = 0 > U ? n.replace("+", "").replace("-", "") : n.replace("-", ""), x += n.replace(/[0]+/, function(a) {
                    return W(U, a.length)
                }));
            v += (M ? w : "") + x;
            return s ? "-" + v : v
        ...
        Oa = function(h) {
            ...
            h.offsetX || 0 === h.offsetX ?
                (n = h.offsetX, v = h.offsetY) : h.layerX || 0 == h.layerX ? (n = h.layerX, v = h.layerY) : (n = h.pageX - h.target.offsetLeft, v = h.pageY - h.target.offsetTop);
            return {
                x: n,
                y: v
            }
        ...
        ea = function(h, n, v, s, w, x, E, F, N, M, P, S, H) {
            ...
            h.globalAlpha = 1;
            0 < E && (H = 0 === E % 2 ? 0 : 0.5, h.beginPath(), h.lineWidth = E, h.strokeStyle =
                F, h.moveTo(n, v), h.rect(n - H, v - H, s - n + 2 * H, w - v + 2 * H), h.stroke());
            h.restore();
            !0 === N && (h.save(), h.beginPath(), h.moveTo(n, v), h.lineTo(n + J, v + J), h.lineTo(s - J, v + J), h.lineTo(s, v), h.closePath(), E = h.createLinearGradient((s + n) / 2, v + J, (s + n) / 2, v), E.addColorStop(0, x), E.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = E, h.fill(), h.restore());
            !0 === M && (h.save(), h.beginPath(), h.moveTo(n, w), h.lineTo(n + J, w - J), h.lineTo(s - J, w - J), h.lineTo(s, w), h.closePath(), E = h.createLinearGradient((s + n) / 2, w - J, (s + n) / 2, w), E.addColorStop(0,
                x), E.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = E, h.fill(), h.restore());
            !0 === P && (h.save(), h.beginPath(), h.moveTo(n, v), h.lineTo(n + J, v + J), h.lineTo(n + J, w - J), h.lineTo(n, w), h.closePath(), E = h.createLinearGradient(n + J, (w + v) / 2, n, (w + v) / 2), E.addColorStop(0, x), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = E, h.fill(), h.restore());
            !0 === S && (h.save(), h.beginPath(), h.moveTo(s, v), h.lineTo(s - J, v + J), h.lineTo(s - J, w - J), h.lineTo(s, w), E = h.createLinearGradient(s - J, (w + v) / 2, s, (w + v) / 2), E.addColorStop(0,
        ...
        cb = window && window[ha("mnb`uhno")] && window[ha("mnb`uhno")].href && window[ha("mnb`uhno")].href.indexOf && (-1 !== window[ha("mnb`uhno")].href.indexOf(ha("b`ow`rkr/bnl")) || -1 !== window[ha("mnb`uhno")].href.indexOf(ha("gdonqhy/bnl")) ||
    ...
    Z.prototype.setOptions = function(h, n) {
        if (pa[this._defaultsKey]) {
            var s = pa[this._defaultsKey],
                w;
            for (w in s) "publicProperties" !== w && s.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : n && w in n ?
                n[w] : s[w])
    ...
    Z.prototype.updateOption = function(h) {
        ...
        var n = pa[this._defaultsKey],
            ...
            J = this._index;
        this.theme && s(this.parent) && s(F) && s(J) ? w = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent &&
            (this.parent.themeOptions && this.parent.themeOptions[F]) && (null === J ? w = this.parent.themeOptions[F] : 0 < this.parent.themeOptions[F].length && (w = Math.min(this.parent.themeOptions[F].length - 1, J), w = this.parent.themeOptions[F][w]));
        this.themeOptions = w;
    ...
    Z.prototype.removeEventListener = function(h, n) {
        if (h && n && this._eventListeners[h])
            for (var s =
                    this._eventListeners[h], w = 0; w < s.length; w++)
    ...
    za.prototype.setLayout = function() {
        if (this.text) {
            var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
                ...
                N, H;
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = n.width - 4 - E * ("center" === this.horizontalAlign ? 2 : 1)), J = 0.5 * n.height - this.margin - 2, F = 0) : "center" ===
                this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = n.height - 4), J = 0.5 * n.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = n.width - 4), J = 0.5 * n.height - 4));
            var M;
            s(this.padding) || "number" !== typeof this.padding ? s(this.padding) || "object" !== typeof this.padding || (M = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0, M += this.padding.bottom ? this.padding.bottom : this.padding.top ?
    ...
    x = Pa.Chart = function() {
        ...
        function n(a, d, c) {
            d = d || {};
            s(c) ? (this.predefinedThemes = bb, this.optionsName = this.parent = this.index = null) : (this.parent = c.parent, this.index = c.index, this.predefinedThemes = c.predefinedThemes, this.optionsName =
        ...
        function E(a, d, c, b, e, f) {
            ...
            "axisX" === e ? ("left" === f || "bottom" === f ? (this.optionsName = "axisX", s(this.chart.sessionVariables.axisX[b]) && (this.chart.sessionVariables.axisX[b] = {}), this.sessionVariables = this.chart.sessionVariables.axisX[b]) : (this.optionsName = "axisX2", s(this.chart.sessionVariables.axisX2[b]) && (this.chart.sessionVariables.axisX2[b] = {}), this.sessionVariables = this.chart.sessionVariables.axisX2[b]), this.options.interval || (this.intervalType = null)) : "left" === f || "bottom" === f ? (this.optionsName = "axisY", s(this.chart.sessionVariables.axisY[b]) && (this.chart.sessionVariables.axisY[b] = {}), this.sessionVariables = this.chart.sessionVariables.axisY[b]) : (this.optionsName = "axisY2",
                s(this.chart.sessionVariables.axisY2[b]) && (this.chart.sessionVariables.axisY2[b] = {}), this.sessionVariables = this.chart.sessionVariables.axisY2[b]);
        ...
        function T(a, d, c, b) {
            ...
            if (this.options.customBreaks && 0 < this.options.customBreaks.length) {
                for (a = 0; a < this.options.customBreaks.length; a++) this.customBreaks.push(new V(this.chart, "customBreaks", this.options.customBreaks[a], a,
                    ++this.chart._eventManager.lastObjectId, this)), "number" === typeof this.customBreaks[a].startValue && ("number" === typeof this.customBreaks[a].endValue && this.customBreaks[a].endValue !== this.customBreaks[a].startValue) && this._appliedBreaks.push(this.customBreaks[a]);
        ...
        n.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (0 <= m.dataSeries.type.indexOf("stacked") ||
                    "pie" === m.dataSeries.type || "doughnut" === m.dataSeries.type) A = this.getPercentAndTotal(m.dataSeries, m.dataPoint);
                ...
                if (null !== D && "" !== D) {
                    ...
                    if ("normal" ===
                        ...
                        "inside" !== A ? (e = c.y1, f = c.y2, 0 < v ? (g = m.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - b, g < e && (g = "auto" === A ? Math.max(m.point.y, e) + r / 2 + t : e + r / 2 + t, x = g + k > m.point.y)) : (g = m.point.y + r / 2 + t + b, g > f - k && (g = "auto" === A ? Math.min(m.point.y, f) + r / 2 - k - t : f + r / 2 - k, x = g < m.point.y))) : (e = Math.max(m.bounds.y1,
                    ...
                    h.y = g;
                    h.render(!0);
                    y && ("inside" !== A && (0 > p.indexOf("bar") && ("error" !== p || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2 || !x) && (0 > p.indexOf("column") && ("error" !== p || m.axisSwapped) && m.point.y > c.y1 &&
                        ...
                        for (var C = !1, u = 0; u < m.length; u++)
                            if (y = m[u].getTime ? m[u].x.getTime() : m[u].x, !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C)))
                                if ("number" !== typeof m[u].y) 0 <
                                    ...
                                    if (0 < m[u].markerSize || 0 < k.markerSize) D = k.getMarkerProperties(u, y, s, c), f.push(D), z = P(z), w && f.push({
                                        x: y,
                                        y: s,
                                        ctx: b,
                                        type: D.type,
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                ea(c, A, p, C, D, b, 0, null, s && 0 <= u[k].y, 0 > u[k].y && s, !1,
                                    !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                        ...
                        for (var s = 5 < g && n.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                    ...
                                    f[b] = z + (D - p)
                                } else z = "undefined" !== typeof l[b] ?
                                    l[b] : 0, D = p + z, p = q + z, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y2 - D) && (D = e.y2), l[b] = z + (D - p);
                                b = u[k].color ? u[k].color : n._colorSet[k % n._colorSet.length];
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() :
                                ...
                                b = P(b);
                                w && ea(this._eventManager.ghostCtx, D, A, m, C, b, 0, null, !1, !1, !1,
                                    !1);
                                (u[k].indexLabel || n.indexLabel || u[k].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                ...
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = A + (B[b] ? B[b] : 0), m = l[b] ? l[b] :
                                    q, l[b] = A = a.axisY.convertValueToPixel(B[b]);
        ...
        n.prototype.renderArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    d = !0;
                    var h = 0,
                        n, u, s, A = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        C, D = null;
                    if (0 < r.length) {
                        ...
                        for (r = !1; q < p.length; q++)
                            if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))
                                if ("number" !== typeof p[q].y) 0 < q && !r && (m.connectNullData ? b.setLineDash && (0 < s.length && (m.options.nullDataLineDashType || !p[q - 1].lineDashType)) &&
                                    ...
                                    q < p.length - 1 && (D !== (p[q].lineColor || C) || z !== (p[q].lineDashType || m.lineDashType)) && (D = p[q].lineColor || C, s[s.length - 1].newStrokeStyle = D, b.setLineDash && (p[q].lineDashType ? (z = p[q].lineDashType, s[s.length -
                        ...
                        for (var Y = !0, q = 0; q < m.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y)))
                                if ("number" !== typeof fa.y) z.connectNullData || (Y || y) || d(), Y = !0;
                                    ...
                                    h[f] = n - r;
                                    y || Y ? (!y && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || A === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (y = k.pop(), A = k[k.length - 1], d(), b.moveTo(u.x, u.y), k.push(A), k.push(y), A = z.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(g,
                                    ...
                                    q < v.length - 1 && (Q !== (v[q].lineColor || x) || A !== (v[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({
                                        x: g,
                                        y: n - ma
                                    }), Q = v[q].lineColor || x, b.strokeStyle = Q, b.setLineDash && (v[q].lineDashType ? (A = v[q].lineDashType, b.setLineDash(N(A, z.lineThickness))) : (A = z.lineDashType, b.setLineDash(E))));
                                    ...
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ma = z.getMarkerProperties(z.dataPointIndexes[f], g, r, b), l.push(ma), f = P(F), w && l.push({
                                        x: g,
                                        y: r,
                                        ctx: s,
                                        type: ma.type,
                ...
                for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (var Y = !0, q = 0; q < m.length; q++) {
                            var f = m[q],
                                fa = null,
                                fa = 0 <= z.dataPointIndexes[f] ? x[z.dataPointIndexes[f]] : {
                                    x: f,
                                    y: null
                                };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y)))
                                if ("number" !== typeof fa.y) z.connectNullData ||
                                    ...
                                    s || Y ? (!s && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || u === z.lineDashType &&
                                        z.lineDashType !== z.nullDataLineDashType) && (s = k.pop(), u = k[k.length - 1], d(), b.moveTo(n.x, n.y), k.push(u), k.push(s), u = z.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(g, r), w && A.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), w && (A.beginPath(), A.moveTo(g, r))), Y = s = !1) : (b.lineTo(g, r), w && A.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && A.moveTo(g, r), k.push({
                                        x: g,
                                        y: y - ba
                                    })));
                                    n = {
                                    ...
                                    q < x.length - 1 && (Q !== (x[q].lineColor || E) || u !== (x[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({
                                        x: g,
                                        y: y -
                                            ba
                                    }), Q = x[q].lineColor || E, b.strokeStyle = Q, b.setLineDash && (x[q].lineDashType ? (u = x[q].lineDashType, b.setLineDash(N(u, z.lineThickness))) : (u = z.lineDashType, b.setLineDash(F))));
                                    if (0 <= z.dataPointIndexes[f]) {
                                    ...
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ba = z.getMarkerProperties(q, g, r, b), t.push(ba), f = P(G),
                                        w && t.push({
                                            x: g,
                                            y: r,
                                            ctx: A,
                    ...
                    if (0 < y.length)
                        for (var A = 5 < r && u.bevelEnabled ? !0 : !1, t = 0; t < y.length; t++)
                            if (y[t].getTime ? g = y[t].x.getTime() : g = y[t].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(y[t].y) && y[t].y.length && "number" === typeof y[t].y[0] &&
                                ...
                                "candlestick" === u.type ? (c.moveTo(h - x, m), c.lineTo(h - x, Math.min(k, q)), c.stroke(), c.moveTo(h - x, Math.max(k, q)), c.lineTo(h - x, p), c.stroke(), ea(c, C, Math.min(k, q), D, Math.max(k, q), y[t].y[0] <= y[t].y[3] ? u.risingColor : f, z, e, A, A, !1, !1, u.fillOpacity), w && (e = P(E), b.strokeStyle = e, b.moveTo(h - x, m), b.lineTo(h - x, Math.min(k,
                ...
                for (var n = !1, n = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < A.length)
                        for (var C = 5 < r && y.bevelEnabled ? !0 : !1, l = 0; l < A.length; l++)
                            if (A[l].getTime ? g = A[l].x.getTime() : g = A[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(A[l].y) && A[l].y.length && "number" === typeof A[l].y[0] && "number" === typeof A[l].y[1] && "number" === typeof A[l].y[2] && "number" === typeof A[l].y[3] && "number" === typeof A[l].y[4] && 5 === A[l].y.length) {
                                ...
                                var D = t - r / 2 << 0,
                                    ...
                                    J = A[l].stemDashType ? A[l].stemDashType :
                                    y.stemDashType,
                                ...
                                (A[l].indexLabel || y.indexLabel || A[l].indexLabelFormatter ||
                            ...
                            for (var F = C._colorSet, t = 0; t < D.length; t++) {
                                ...
                                if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(D[t].y) && D[t].y.length && "number" === typeof D[t].y[0] && "number" === typeof D[t].y[1]) {
                                    ...
                                    b ? (q = a.axisX.reversed ? k + (z ?
                                        v : 1) * u / 2 - (z ? E - 1 : 0) * u << 0 : k - (z ? v : 1) * u / 2 + (z ? E - 1 : 0) * u << 0, g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (m = a.axisX.reversed ? h + (z ? v : 1) * u / 2 - (z ? E - 1 : 0) * u << 0 : h - (z ? v : 1) * u / 2 + (z ? E - 1 : 0) * u << 0, p = a.axisX.reversed ? m - u << 0 : m + u << 0);
                                    !b && q > g && (ja = q, q = g, g = ja);
                                    b && m > p && (ja = m, m = p, p = ja);
                                    ja = C.dataPointIds[t];
                            ...
                            if (u = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !Q)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || Q ? (m.connectNullData && !q ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType &&
                                        m.lineDashType !== m.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = E, z = m.nullDataLineDashType, b.setLineDash(x)), b.lineTo(r, n), w && e.lineTo(r, n), h.push({
                                        x: r,
                                        y1: n,
                                        y2: s
                        ...
                        for (g = !1; p < m.length; p++)
                            if (q = m[p].x.getTime ? m[p].x.getTime() : m[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                                ...
                                if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                                    ...
                                    p < m.length - 1 && (A !== (m[p].lineColor || y) || C !== (m[p].lineDashType || k.lineDashType)) && (A = m[p].lineColor || y, s[s.length -
                                        1].newStrokeStyle = A, b.setLineDash && (m[p].lineDashType ? (C = m[p].lineDashType, s[s.length - 1].newLineDashArray = N(C, k.lineThickness)) : (C = k.lineDashType, s[s.length - 1].newLineDashArray = D)));
                                    ...
                                    (0 < s.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = z, C = k.nullDataLineDashType) : (d(D, y), s = [], x = [])), g = !0;
                        d(D, y);
                        $.drawMarkers(f)
                    }
                }
                    ...
                    if (0 < v.length)
                        for (var A = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, x = null, z = null, l = 0; l < v.length; l++)
                            if (v[l].getTime ?
                                ...
                                0 < l && x && (!C || s.connectNullData) && (C && c.setLineDash && c.setLineDash(N(E, u)), c.beginPath(), c.moveTo(x, z - y), c.lineTo(Q, aa - y), 0 < u && c.stroke(), w && (b.beginPath(), b.moveTo(x, z - y), b.lineTo(Q, aa - y), 0 < u && b.stroke()));
                                C = !1;
                                x = F;
                                z = 0 < v[l].y ? n : k;
        ...
        n.prototype.renderPie = function(a) {
            ...
            function c(a) {
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        ...
                        } else if (0 < Math.abs(g[b].center.x - A.x) || 0 < Math.abs(g[b].center.y - A.y)) g[b].center.x = A.x + e * (1 - a), g[b].center.y = A.y + f * (1 - a),
                            l = !0;
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < m.length) {
                    ...
                    l && (d = p.indexLabelTextBlock.y + l, c = 0, c = "right" === p.hemisphere ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)) : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)), p.midAngle > Math.PI / 2 - u && p.midAngle < Math.PI / 2 + u ? (k = (a - 1 + g.length) % g.length, k = g[k], a = g[(a + 1 + g.length) % g.length], "left" === p.hemisphere &&
            ...
            function l() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    if ("inside" !== k.indexLabelPlacement) {
                        ...
                        for (a = 0; a < m.length; a++) h = g[a], w = "pie" === k.type ? 0.7 * z : 0.8 * z, u = A.x + w * Math.cos(h.midAngle), s = A.y + w * Math.sin(h.midAngle), h.indexLabelTextBlock.x = u, h.indexLabelTextBlock.y = s;
                    for (a = 0; a < m.length; a++)
        ...
        n.prototype.renderFunnel =
            function(a) {
                ...
                function b() {
                    if (u && y) {
                        for (var a, b, c, d, e, f, k, l, h, m, p, q, t, n, r, B = [], v = [], A = {
                                percent: null,
                                total: null
                            }, C = null, z = 0; z < y.length; z++) r = O[z],
                            r = "undefined" !== typeof r.x5 ? (r.y2 + r.y4) / 2 : (r.y2 + r.y3) / 2, r = g(r).x2 + 1, B[z] = M - r - U;
                        r = 0.5 * U;
                        for (var z = 0, D = y.length - 1; z < y.length || 0 <= D; z++, D--) {
                            ...
                            b = b.indexLabelFormatter ? b.indexLabelFormatter(C) : b.indexLabel ? x.replaceKeywordsWithValue(b.indexLabel, b, u, z) : u.indexLabelFormatter ? u.indexLabelFormatter(C) : u.indexLabel ? x.replaceKeywordsWithValue(u.indexLabel, b, u, z) : b.label ?
                                b.label : "";
                            0 >= m && (m = 0);
                ...
                var x = this;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    for (var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, A = this.plotArea, C = 0.025 * A.width, D = 0.01 * A.width, z = 0, E = A.height - 2 * C, F = Math.min(A.width - 2 * D, 2.8 * A.height), J = !1, H = 0; H < y.length; H++)
        ...
        F.prototype.setLayout = function() {
                    ...
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        ...
                        for (var y = 0; y < p.dataPoints.length; y++) {
                            var A = p.dataPoints[y],
                                ...
                                u = A.legendMarkerBorderThickness ? A.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : A.markerBorderThickness || p.markerBorderThickness ?
            ...
            if (0 < n.length) {
                p = null;
                r = g = A = y = 0;
                A = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, f) : this.itemMaxWidth = Math.min(this.itemWidth,
        ...
        E.setLayout = function(a, d, c, b, e, f) {
            ...
            for (var v = w = 0, u = 0, y = 0, x = 0, C = 0, D = 0, z, E, F = h = 0, H, J, K, r = H = J = K = !1, g = 0; g < q.length; g++) q[g] && q[g].title && (q[g]._titleTextBlock = new ia(q[g].ctx, {
                text: q[g].title,
                horizontalAlign: "center",
            ...
            if ("normal" === e) {
                for (var y = [], x = [], C = [], D = [], M = [], N = [], P = [], R = []; 4 >
                    ...
                    var G = 0,
                        ...
                        $ = 0;
                    if (c && 0 < c.length)
                        for (C = [], g = O = 0; g < c.length; g++) C.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += C[g], L += c[g] && !m.isNavigator ? c[g].margin : 0;
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) L = m.isNavigator ? 0 : 10, c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + V + W < Math.max(L, p) ? Math.max(L, p) : f.y1 + V + W), n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height /
                            2 : p, k = Math.round(f.y2 - T - e - L), c[g].lineCoordinates = {
                                ...
                                c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), U += C[g] + c[g].margin);
                    if (b && 0 < b.length)
                ...
                for (N = []; 4 > w;) {
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && 0 < b[g]._labels.length && (k = b[g]._labels[0], h = b[g]._labels[b[g]._labels.length - 1], C = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), D = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)));
                    if (m.panEnabled)
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("rangeBar" === m[0].dataSeries.type || "error" ===
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), A = u = 0, r = x = 0; r <
                            m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), C = A = u = 0, r = 0; r < m.length; r++)
                            ...
                            else A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(a - this.parent.convertValueToPixel(C)), u < v && (v = u, x = r);
                    else
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type) {
                            ...
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            A = u = 0;
                            for (r = x; 0 <= r; r--) A += m[r].dataPoint.y, u = Math.abs(a -
                            ...
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            C = A = u = 0;
                            for (r = x; 0 <= r; r--) A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(a - this.parent.convertValueToPixel(C)), u < v && (v = u, b = r);
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = C = A = u = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y])),
                                    u < v && (v = u, x = r);
                            else A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(d - this.parent.convertValueToPixel(C)), u < v && (v = u, x = r);
                    else
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[x].type || "rangeArea" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type || "rangeSplineArea" === this.parent.dataSeries[x].type || "candlestick" === this.parent.dataSeries[x].type || "ohlc" === this.parent.dataSeries[x].type || "boxAndWhisker" === this.parent.dataSeries[x].type) {
                        ...
                        v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
                        A = u = 0;
                        for (r = x; 0 <= r; r--) A += m[r].dataPoint.y, C = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, C = 100 * (A / m[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(d - this.parent.convertValueToPixel(C)), u < v && (v = u, b = r);
                        w =
        ...
        W.prototype.getToolTipInnerHTML = function(a) {
            ...
            for (var h = 0; h < a.length; h++)
                if (a[h].dataSeries.toolTipContent || a[h].dataPoint.toolTipContent) {
                    ...
                    toolTip: this.options,
                    entries: a
                }, d = this.contentFormatter ? this.contentFormatter(a) :
                this.content(a);
                ...
                for (var n = null, s = "", h = 0; h < a.length; h++) c = a[h].dataSeries, b = a[h].dataPoint, e = a[h].index, f = "", 0 === h && (this.isToolTipDefinedInData && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? s += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ? this.chart.axisX[0].labels[b.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length && (s += "undefined" !== typeof this.chart.axisX2[0].labels[b.x] ? this.chart.axisX2[0].labels[b.x] :
                    ...
                    (d = this.chart.replaceKeywordsWithValue(f, b, c, e) + d, h < a.length - 1 && (d = "</br>" + d)) : (d += this.chart.replaceKeywordsWithValue(f, b, c, e), h < a.length - 1 && (d += "</br>")));
                null !== d && (d = s + d)
            } else {
                c = a[0].dataSeries;
                b = a[0].dataPoint;
                ...
                "line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" ===
                ...
                null === d && (d = "");
                d += this.chart.replaceKeywordsWithValue(f, b, c,
                    e)
            }
            return d
        };
        ...
        W.prototype.showAtX = function(a, d) {
            ...
            if (0 < f.length) {
                for (h = 0; h < f.length; h++)
                    if (b = f[h], b.dataPoint.x < b.dataSeries.axisX.viewportMinimum || b.dataPoint.x > b.dataSeries.axisX.viewportMaximum || b.dataPoint.y < b.dataSeries.axisY.viewportMinimum ||
                        b.dataPoint.y > b.dataSeries.axisY.viewportMaximum) e = !0;
                    else {
                        e = !1;
                        break
                ...
                if (null !== h) {
                    ...
                    "pie" === f[0].dataSeries.type || "doughnut" === f[0].dataSeries.type || "funnel" === f[0].dataSeries.type || "pyramid" === f[0].dataSeries.type ? c = mouseX - 10 - this.container.clientWidth : (c = "bar" === f[0].dataSeries.type || "rangeBar" === f[0].dataSeries.type || "stackedBar" === f[0].dataSeries.type ||
                        "stackedBar100" === f[0].dataSeries.type ? f[0].dataSeries.axisY.convertValueToPixel(f[0].dataPoint.y) - this.container.clientWidth << 0 : f[0].dataSeries.axisX.convertValueToPixel(f[0].dataPoint.x) - this.container.clientWidth << 0, c -= 10);
                    ...
                    f = 1 !== f.length || this.shared || "line" !== f[0].dataSeries.type &&
                        "stepLine" !== f[0].dataSeries.type && "spline" !== f[0].dataSeries.type && "area" !== f[0].dataSeries.type && "stepArea" !== f[0].dataSeries.type && "splineArea" !== f[0].dataSeries.type ? "bar" === f[0].dataSeries.type || "rangeBar" === f[0].dataSeries.type || "stackedBar" === f[0].dataSeries.type || "stackedBar100" === f[0].dataSeries.type ? f[0].dataSeries.axisX.convertValueToPixel(f[0].dataPoint.x) : f[0].dataSeries.axisY.convertValueToPixel(f[0].dataPoint.y) : f[0].dataSeries.axisY.convertValueToPixel(f[0].dataPoint.y);
                    f = -f + 10;
                    0 <
                        f + this.container.clientHeight + 5 && (f -= f + this.container.clientHeight + 5 - 0);
        ...
        X.prototype.animate = function(a, d, c, b, e) {
            ...
            for (a = []; 0 < this.animations.length;)
                if (d = this.animations.shift(),
                    c = (new Date).getTime(), b = 0, d.startTime <= c && (b = e(Math.min(c - d.startTime, d.duration), 0, 1, d.duration), b = Math.min(b, 1), isNaN(b) || !isFinite(b)) && (b = 1), 1 > b && a.push(d), d.animationCallback(b), 1 <= b && d.onComplete) d.onComplete();
            this.animations = a;
            ...
            $ = {
                drawMarker: function(a, d, c, b, e, f, h, n) {
                    if (c) {
                        ...
                        "circle" === b ? (c.moveTo(a, d), c.beginPath(), c.arc(a, d, e / 2, 0, 2 * Math.PI, !1), f && c.fill(), n && (h ? c.stroke() : (s = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "black", c.stroke(), c.globalAlpha = s))) : "square" === b ? (c.beginPath(), c.rect(a - e / 2, d - e / 2, e, e), f && c.fill(), n && (h ? c.stroke() : (s = c.globalAlpha, c.globalAlpha =
