...
@section('PageContent')
    ...
    <div class="page-content">
        ...
        <!--end row-->
        @if (has_permission($resultArray, 'Candidate Rejection List'))
            <div class="row">
                <div class="col-3">
                    <div class="card radius-10 border-start border-0 border-4 border-info">
                        <a href="/hod/rejected_candidate">
                            <div class="card-body">
                                <div class="text-center">
                                    <h5 class="my-1">{{ $rejectedCandidateCount }}</h5>
                                    <p class="mb-0 text-secondary">Rejected by HR Screening</p>
                                </div>
                            </div>
                        </a>
                    </div>
