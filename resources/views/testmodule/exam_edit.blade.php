            ...
            <div class="card border-top border-0 border-4 border-success">
                <div class="card-body p-3">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-success">Update Online Exam </h5>
                    </div>
                    <hr class="mb-3">
                    <form action="{{route('exam_master.update',$exam_detail->id)}}" method="POST" id="addExamForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="exam_name" id="exam_name" class="form-control" value="{{$exam_detail->exam_name}}">
                                            ...
                                            @foreach($test_papers as $key => $test_paper)
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" style="font-size: 16px;"
                                                           ...
                                                           name="test_paper[]" value="{{$test_paper['id']}}" @if(in_array($test_paper['id'],explode(",",$exam_detail->test_paper))) checked @endif>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="time" id="time" class="form-control d-inline"
                                                   style="width: 30%" value="{{$exam_detail->time}}"> <span>In minutes (Except FIRO B)</span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="time_reminder" id="time_reminder"
                                                   class="form-control d-inline" style="width: 30%" min="2" value="{{$exam_detail->time_reminder}}"> <span>In minutes</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select name="max_alert" id="max_alert" class="form-select"
                                                    style="width: 30%">
                                                @for($i =2; $i <= 5; $i++)
                                                    <option value="{{$i}}" @if($i == $exam_detail->max_alert) selected @endif>{{$i}}</option>
                                                @endfor
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <textarea name="instruction" id="instruction" class="form-control">{{$exam_detail->instruction}}</textarea>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="status" id="status" class="form-select"
                                                    style="width: 30%">
                                                <option value="A" @if($exam_detail->status =='A') selected @endif>Active</option>
                                                <option value="D" @if($exam_detail->status == "D") selected @endif>Inactive</option>
                                            </select>
                                        </td>
                                    </tr>
                                    </tbody>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.status === 400) {
                            ...
                            setTimeout(function () {
                                window.location.href = "{{route('exam_master.index')}}";
                            }, 1000);
                        }
                    }
                });
