...
$check = DB::table('firob_user')->where('userid',$JCId)->first();
@endphp
                ...
                <div class="col-7 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="card-text text-danger">Employee Does not given the FIRO B Test from Recruitment Application.</h5>
