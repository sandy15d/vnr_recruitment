        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-condensed table-bordered text-center" id="MRFTable" style="width: 100%">
                        <thead class="bg-success text-light">
                            ...
                            <th>Status</th>
                            <th style="width: 200px;">Allocated Task to</th>
                    ...
                    <div class="modal-body">
                        <table class="table borderless">
                            ...
                            <tr id="onbehalf_tr" class="d-none">
                                <th>On Behalf Of:</th>
                                <td>
                                    <select id="OnBehalf" name="OnBehalf"
...
@section('script_section')
    <script>
        ...
        function reportingApproveEditStatus(MRFId, th) {
            $('#reporting_approve' + MRFId).prop('disabled', false);
        }

        function hodApproveEditStatus(MRFId, th) {
            $('#hod_approve' + MRFId).prop('disabled', false);
        }

        function managementApproveEditStatus(MRFId, th) {
            $('#management_approve' + MRFId).prop('disabled', false);
        }
        ...
        function chngreportingApprove(MRFId,va){
            let RemarkHr = prompt("Please Enter Remark");
            if (RemarkHr != null) {
                $.ajax({
                    url: "{{ route('changeMRFStatusOnBehalfReporting') }}",
                    type: 'POST',
                    data: {
                        MRFId: MRFId,
                        va: va,
        ...
        function chnghodApprove(MRFId,va){
            let RemarkHr = prompt("Please Enter Remark");
            if (RemarkHr != null) {
                $.ajax({
                    url: "{{ route('changeMRFStatusOnBehalfHod') }}",
                    type: 'POST',
                    data: {
                        MRFId: MRFId,
                        va: va,
        ...
        function chngmanagementApprove(MRFId,va){
            let RemarkHr = prompt("Please Enter Remark");
            if (RemarkHr != null) {
                $.ajax({
                    url: "{{ route('changeMRFStatusOnBehalfManagement') }}",
                    type: 'POST',
                    data: {
                        MRFId: MRFId,
                        va: va,
