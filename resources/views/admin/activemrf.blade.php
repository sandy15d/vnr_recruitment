...
@section('PageContent')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb  align-items-center mb-3">
            <div class="row mb-2">
                <h5 class="download_label text-muted">Active MRF Details</h5>
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <select name="MRFType" id="MRFType" class="form-select form-select-sm" onchange="GetActiveMRF();">
                ...
                <div class="col-2">
                    <select name="Recruiter" id="Recruiter" class="form-select form-select-sm" onchange="GetActiveMRF();">
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 400) {
                        ...
                        $('#loader').modal('hide');
                        toastr.success(data.msg);
                        window.location.href = "{{ route('admin.active_mrf') }}";
                    }
                }
            });
        });
