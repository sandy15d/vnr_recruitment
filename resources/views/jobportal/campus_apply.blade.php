...
@php
    ...
    $query = DB::table('jobpost')
        ...
        ->Where('JPId', $jpid)
        ->select('jobpost.*', 'core_department.department_name as DepartmentName')
        ->first();
    $MRFId = $query->MRFId;
                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    <div class="text-center">
                                        ...
                                        <h5 class="">Application for : {{ $query->DepartmentName }} Department</h5>
                                    </div>
                                    ...
                                    <p style="font-size: 14px; margin-bottom:0px;">This Campus placement activity is
                                        ...
                                        from other College / University please do not apply.</p>
                                    <hr style="margin: 10px 0px 10px 0px;">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-9 col-sm-12 table-responsive">
                                                    <table class=" table borderless d-inline-block">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text"
                                                                    ...
                                                                    name="LName" onblur="return convertCase(this)" onkeypress="return isLetterKey(event)">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td valign="middle">Permanent Address<font color="#FF0000">*
                                                                </font>
                                                            </td>
                                                            <td>
                                                                <table style="width: 100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="PassingYear" id="PassingYear"
                                                                    class="form-select form-select-sm reqinp">
                                                                    <option value="">Select</option>
                                                                    @for ($i = 1980; $i <= date('Y', strtotime('+2 years')); $i++)
                                                                        <option value={{ $i }}>
                                                                            {{ $i }}</option>
                                                                    @endfor
                                                                </select>
