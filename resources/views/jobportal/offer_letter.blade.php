                ...
                <div class="col-6 mx-auto">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            ...
                            <p class="card-text">System is under maintenance. Please try again later.</p>
                        ...
                        <div class="subpage">
                            ...
                            <ol>
                                ...
                                @elseif($sql->TempS == 1 && $sql->FixedS == 1)
                                    <li>For minimum {{ $months_word[$sql->TempM] }} months, your temporary headquarter
                                        will
                                        be
                                        <strong>{{ getHq($sql->T_LocationHq) }}
                                            ({{ getHqStateCode($sql->T_StateHq) }})
                                        </strong>

                                        @if ($sql->T_StateHq1 > 0)
                                            or
                                            <strong>{{ getHq($sql->T_LocationHq1) }}
                                                ({{ getHqStateCode($sql->T_StateHq1) }})
                                            </strong>
                                        @endif
                                    ...
                                    @else
                                        @if ($sql->Functional_R != 0 && $sql->Admins_R != 0)
                                            <li>For administrative purpose you shall be reporting to
                                                ...
                                                and will work under the supervision of such officers as may be decided
                                                upon
                                                by the
                                        ...
                                        @else
                                            <li>You will report to
                                                <strong>{{ getFullName($sql->A_ReportingManager) }},
                                                    {{ getEmployeeDesignation($sql->A_ReportingManager) }}</strong> and
                                                will
                                                work under the supervision of such officers as may be decided upon by
                                                the
                                                management
                                                of
                                                the Company, from time to time.
                                    ...
                                    @else
                                        ...
                                        @elseif($sql->Department == 2 || $sql->Department == 3)
                                            ...
                                            <li>During the {{ $sql->ServiceCondition }} Period, either you or the
                                                Company may
                                                terminate this
                                                employment by giving 1 (One) month notice in writing or salary in
                                                lieu
                                                of such notice period. Pursuant to your confirmation, the aforementioned
                                                notice
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"
                                            style="font-weight: bold;">{{ $ctc->grsM_salary ?? '' }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"
                                            style="font-weight: bold;">{{ $ctc->netMonth ?? '' }} </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"
                                            style="font-weight: bold;">{{ $ctc->anualgrs ?? '' }}</td>
                                    </tr>
                                    <tr>
                        ...
                        @endif
                            ...
                            @if ($sql->Company == 1)
                                <ul type="none">
                                    <li>
                                        <ol type="a">
                                            <li>Performance Pay is an annually paid variable component of CTC, paid in
                                                July
                                                salary.
                                            </li>
                                            <li>This amount is indicative of the target variable pay, actual pay-out
                                                will vary
                                                based on the performance of Company and Individual.
                                            </li>
                                            <li>It is linked with Company performance (as per fiscal year) and
                                                Individual
                                                Performance (as per appraisal period for minimum 6 months working,
                                                pro-rata
                                                basis if <1 year working).
                                            </li>
                                            <li>The calculation shall be based on the pre-defined performance measures
                                                at both,
                ...
                <div id="entitlement">
                    <div class="page">
                        <div class="subpage">
                            ...
                            <br>
                            <p class="text-center"><b><u>LIST OF DOCUMENTS REQUIRED DURING APPOINTMENT</u> (whichever
                                    is applicable)</b></p>
                            <ol>
                            ...
                            <b>Note: </b>
                            <ul>
                                <li>The above 2 Wheeler & 4 Wheeler travel eligibility is subject to submission of
                                    vehicle details belonging in the name of employee only.
                                </li>
                                <li>In case, the vehicle documents are in the name of family member, flat rate policy
                                    apply.
                                </li>
                            </ul>
                            <br><br>
