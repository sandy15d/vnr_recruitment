                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control form-control-sm"
                                                                    ...
                                                                    placeholder="Middle Name as per Aadhaar" onkeypress="return isLetterKey(event)">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text"
                                                                    ...
                                                                    placeholder="Last Name as per Aadhaar" onkeypress="return isLetterKey(event)">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="text"
                                                                                ...
                                                                                placeholder="Father Name as per Aadhaar" onkeypress="return isLetterKey(event)">
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
