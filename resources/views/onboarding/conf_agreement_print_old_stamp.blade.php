...
<p style="text-align: justify"> This Confidentiality agreement ("<strong>Agreement</strong>") in
    ...
    @if ($sql->ConfLtrDate != '')
        {{ date('dS', strtotime($sql->ConfLtrDate)) }}
    @else
        {{ date('dS') }}
    @endif
    day of
...
<ol type="a">
    <li> The company has selected the Employee for the post <b
            style="font-weight: bold;">{{ getCandidateFullDesignation($sql->JAId) }}</b> at
        ...
        <b style="font-weight: bold;">{{ date('d-m-Y', strtotime($sql->JoinOnDt)) }}</b> and the Employee has agreed to
        abide with the said
...
<ol type="a" start="2">
    <li>The Company and its direct or indirect subsidiaries or affiliates or associate companies
        ...
        prevent others from using the above;
    </li>
    ...
    <li>
        <ol type="a">
            ...
            <li>The Company’s material such as biological material, germplasm, germplasm resources,
                ...
                Plans; Research and Development; Acquisition Transaction and Personal Plans.
            </li>
            ...
            <li>Information submitted by Company’s customers, suppliers, Employees, consultants or
                co-venture partners with the Company for study, evaluation or use;
            </li>
    ...
    <li>
        <ol type="a" start="7">
            ...
            <li>Any other information, which is unique to the Company or which, gives the Company an
                advantage over competitors who do not have such information; and
            </li>
    ...
    <li>
        <ol type="a">
            <li>Registered plant varieties and applications under the Protection of Plant Varieties
                ...
                other jurisdiction other than India;
            </li>
            ...
            <li>Domain names or uniform resource locators used in connection with any global
                ...
                code, object code, data and documentation relating thereto; and
            </li>
    ...
    <li>
        <ol type="a">
            ...
            <li>All similar or equivalent rights or forms of protection which subsist or will
                subsist now or in the future in all countries except India.
            </li>
        </ol>
    </li>
</ul>
    ...
    <li>
        <ol type="a">
            ...
            <li>The ejusdem generis rule does not apply to this Agreement. Accordingly, specific
                ...
                thing indicated by such specific words.
            </li>
    ...
    <li>
        <ol type="a">
            ...
            <li>Prosecution of any claim, demand, suit, action or proceeding against the person that
                is liable for such loss or unauthorized disclosure.
            </li>
        </ol>
    </li>
</ul>
