...
<div>
    ...
    <ol style="text-align: justify;">
        ...
        @if ($sql->ServiceBond == 'Yes')
            <li>
                ...
                Company
                continuously for a minimum period of <b>{{ $months_word[$sql->ServiceBondYears] }}
                </b> years
                from
            ...
            <li>
                ...
                <ol type="a">
                    <li>
                        ...
                        months
                        from the Appointment Date (<strong>“Probation Date”</strong>) which maybe
                        either
                        extended or may
                        be
        ...
        <li>
            ...
            <ol type="a">
                ...
                <li>The Company views the compensation offered to you as an extremely
                    ...
                    breach of
                    the confidence and conditions of employment at your level.
                </li>
        ...
        <li>
            ...
            <ol type="a" style="margin-top: 5px;">
                <li>You will intimate in writing to the Company any change of address within a week
                    ...
                    recorded address shall be deemed to have served on you.
                </li>
            </ol>
    ...
    <div style="text-align: center; font-weight:bold; margin-top:10px; ">
        ...
        {{-- <div style="float: right; width: 50%; text-align: right;">_________________<br>{{ $sql->FName }} {{ $sql->MName }}
             {{ $sql->LName }}</div>--}}
    </div>
    <strong>
        <p>Enclosed:</p>
    ...
    @endphp
    <p style="text-align: justify;margin-bottom: 0">I, <strong> {{ $sql->FName }}
            {{ $sql->MName }}
...
<pagebreak>
    ...
    <div style="text-align: center;margin-left:50px;">
        <table class="table" style="width: 100%;font-size:14px;">
            ...
            <tr style="">
                <td style="">Basic</td>
                <td class="text-center" style="">{{ $ctc->basic ?? '' }}</td>
            </tr>
            @if ($ctc->hra)
                <tr>
                    <td>HRA</td>
            ...
            @if ($ctc->bonus)
                <tr style="">
                    ...
                    <td class="text-center" style="">{{ $ctc->bonus ?? '' }}</td>
                </tr>
            @endif
            @if ($ctc->special_alw)
                <tr style="">
                    <td style="">Special Allowance</td>
                    <td class="text-center" style="">{{ $ctc->special_alw ?? '' }}</td>
                </tr>
            @endif
            <tr style="">
            ...
            <tr style="">
                ...
                <td class="text-center" style="">{{ $ctc->emplyPF ?? '' }}</td>
            </tr>
            @if ($ctc->grsM_salary <= 21000)
                <tr>
                    <td style="">Employee’s ESIC Contribution</td>
                    <td class="text-center" style="">{{ $ctc->emplyESIC ?? '' }}</td>
                </tr>
            @endif
            <tr style="">
            ...
            <tr style="">
                ...
                <td class="text-center" style="">{{ $ctc->lta }} </td>
            </tr>
            <tr style="">
                <td style="">Child Education Allowance</td>
                <td class="text-center" style="">{{ $ctc->childedu }}</td>
            </tr>
            <tr style="">
            ...
            <tr style="">
                ...
                <td class="text-center" style="">{{ $ctc->gratuity ?? '' }}</td>
            </tr>
            <tr style="">
                <td style="">Employer’s PF contribution</td>
                <td class="text-center" style="">{{ $ctc->emplyerPF ?? '' }}</td>
            </tr>
            @if ($ctc->grsM_salary <= 21000)
                <tr>
                    <td style="">Employer’s ESIC contribution</td>
                    <td class="text-center" style="">{{ $ctc->emplyerESIC ?? '' }} </td>
                </tr>
            @endif
            @if ($ctc->medical > 0)
                <tr>
                    <td style="">Insurance Policy Premium</td>
                    <td class="text-center" style="">{{ $ctc->medical ?? '' }}</td>
                </tr>
            @endif
    ...
    <p style="margin: 0px;"><b>Notes:</b></p>
    <ol type="1">
        ...
        @if ($sql->Company == 1)
            <li style="font-size: 14px;">Performance Pay</li>
        @endif
    </ol>
    @if ($sql->Company == 1)
        <ul type="none" style="margin-bottom: 0px;">
            <li style="font-size: 14px; margin-bottom: 0px;">
                <ol type="a" style="margin-bottom: 0px;">
                    <li style="font-size: 14px;margin-bottom: 2px;">Performance Pay is an annually paid variable
                        component of CTC, paid in July
                        salary.
                    </li>
                    <li style="font-size: 14px;margin-bottom: 2px;">This amount is indicative of the target variable
                        pay, actual pay-out will
                        vary
                        based on the performance of Company and Individual.
                    </li>
                    <li style="font-size: 14px;margin-bottom: 2px;">It is linked with Company performance (as per fiscal
                        year) and Individual
                        Performance (as per appraisal period for minimum 6 months working, pro-rata
                        basis if <1 year working).
                    </li>
                    <li style="font-size: 14px;margin-bottom: 2px;">The calculation shall be based on the pre-defined
        ...
        {{-- <p style="margin: 0px;">For more details refer to the Company’s Performance Pay policy.</p> --}}
    @endif
    ...
    <div style="text-align: center;margin-left:50px;"></div>
    ...
    {{--@if(!empty($elg->CostOfVehicle) && $elg->CostOfVehicle != 'NA')
        <table class="table" style="width: 100%;font-size:16px;margin-top: 2px;">
            <tr>
    ...
    <b>Note: </b>
    <ul>
        <li>The above 2 Wheeler & 4 Wheeler travel eligibility is subject to submission of vehicle details belonging in
            the name of employee only.
        </li>
