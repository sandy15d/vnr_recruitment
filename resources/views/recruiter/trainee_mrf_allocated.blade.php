    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <hr />
                <div>
                    <table class="table  table-condensed align-middle table-bordered" id="MRFTable" style="width: 100%">
                        <thead class="text-center bg-success text-light">
                            ...
                            <th>Position</th>
                            <th>Location</th>
                            <th class="noExport">Job Posting</th>
                            <th class="noExport">View on Site</th>
                            <th class="noExport">Action</th>
                            <th class="noExport">Link</th>
                    ...
                    exportOptions: {
                        ...
                        format: {
                            body: function(inner, rowidx, colidx, node) {
                                if ($(node).children(".linkbox").length > 0) {
