...
@section('PageContent')
    ...
    <div class="page-content">
        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
            ...
            <div class="col">
                <div class="card radius-10 border-start border-0 border-3 border-danger mb-3">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <hp class="mb-0 text-secondary">Total Screening by HR:</hp>
                            </div>
                            <div class="ms-auto font-20 my-1 text-danger">{{ $total_hr_scr }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card radius-10 border-start border-0 border-3 border-info mb-3">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                            ...
                            <div class="ms-auto font-20 my-1 text-info">{{ $total_fwd }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card radius-10 border-start border-0 border-3 border-warning mb-3">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                            ...
                            <div class="ms-auto font-20 my-1 text-warning">{{ $total_available }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-top border-0 border-4 border-success mb-1">
                    <div class="card-body d-flex justify-content-between" style="padding: 5px;">
                        ...
                        <span style="float: right"><button type="button" class="btn btn-primary btn-sm"
                                                           ...
                                                           data-bs-target="#application_form_modal"><i
                                                ...
                                                <td style="text-align: left">:
                                                    @php
                                                        if ($row->Professional == 'F') {
                                                            ...
                                                            if($row->TotalYear != null || $row->TotalMonth != null){
                                                                echo $row->TotalYear.' Years '.$row->TotalMonth.' Months';
                                                            }
                ...
                <div class="card border-top border-0 border-4 border-danger">
                    <div class="card-body">
                        ...
                        <div class="col-12 mb-3">
                                ...
                                <select name="Experience" id="Experience" class="form-select form-select-sm"  onchange="GetApplications();">
                            ...
                            @if (isset($_REQUEST['Experience']) && $_REQUEST['Experience'] != '')
                                <script>
                                    $('#Experience').val('<?= $_REQUEST['Experience'] ?>');
                                </script>
                            @endif
...
@section('script_section')
    <script>
        $(document).ready(function () {
            ...
            function GetApplications() {
                ...
                window.location.href = "{{ route('job_applications') }}?Company=" + Company + "&Department=" +
                    ...
                    "&Education=" + Education +  "&Experience=" + Experience + "&Name=" + Name + "&Email=" + Email + "&Phone=" + Phone + "&ManualEntry=" + ManualEntry + "&State=" + State+ "&City=" + City;
            }
        ...
        $("#bulk_download_cv").click(function() {
            ...
            window.location.href = "{{ route('download_bulk_cv_all') }}?" + queryString;
        });
    </script>
@endsection
